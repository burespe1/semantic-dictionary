---
id: dynamic-road-status-variable-road-user-charges-and-available-payment-methods
...
**Dynamic road status – _variable road user charges and available payment methods_:**
dynamic information disseminating variable road user charges responding to a congestion/emission pricing policy scheme and the available payment methods.
