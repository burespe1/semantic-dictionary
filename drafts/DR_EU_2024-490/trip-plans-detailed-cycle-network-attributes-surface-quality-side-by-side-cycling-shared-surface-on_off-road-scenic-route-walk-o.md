---
id: trip-plans-detailed-cycle-network-attributes-surface-quality-side-by-side-cycling-shared-surface-on_off-road-scenic-route-walk-o
label: detailed cycle network attributes (surface quality, side-by-side cycling, shared surface, on_off road, scenic route, “walk only”, turn or access restrictions, e.g., against flow of traffic)
