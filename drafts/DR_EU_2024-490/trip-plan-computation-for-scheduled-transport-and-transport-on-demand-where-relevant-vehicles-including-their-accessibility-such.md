---
id: trip-plan-computation-for-scheduled-transport-and-transport-on-demand-where-relevant-vehicles-including-their-accessibility-such
label: for scheduled transport and transport on demand where relevant - vehicles, including their accessibility (such as low floor, wheelchair accessible, pram accessible) and accessibility of on-board services (such as toilets)
