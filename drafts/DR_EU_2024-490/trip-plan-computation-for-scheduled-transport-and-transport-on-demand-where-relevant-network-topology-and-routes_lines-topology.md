---
id: trip-plan-computation-for-scheduled-transport-and-transport-on-demand-where-relevant-network-topology-and-routes_lines-topology
label: for scheduled transport and transport on demand where relevant - network topology and routes_lines (topology)
