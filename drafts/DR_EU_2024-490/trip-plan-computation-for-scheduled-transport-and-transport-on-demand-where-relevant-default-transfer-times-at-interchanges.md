---
id: trip-plan-computation-for-scheduled-transport-and-transport-on-demand-where-relevant-default-transfer-times-at-interchanges
label: for scheduled transport and transport on demand where relevant - default transfer times at interchanges
...
**Trip plan computation – _for scheduled transport and transport on demand where relevant - default transfer times at interchanges_**
the minimum information required for indicating the amount of time allocated for passengers to switch between different vehicles at interchanges, essential for trip plan computation purposes.
