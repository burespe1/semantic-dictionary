---
id: location-search-access-nodes-for-scheduled-transport-and-transport-on-demand-where-relevant-geometry_map-layout-structure-of-acc
label: for scheduled transport and transport on demand where relevant - geometry_map layout structure of access nodes
