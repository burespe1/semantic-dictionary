...
### Static and dynamic traffic regulations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location and identification of traffic signs reflecting traffic regulations and identifying dangers ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Other static and dynamic traffic regulations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Variable road user charges and available payment methods, including retail channels and fulfilment methods ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### Location of compressed natural gas, liquefied natural gas, liquefied petroleum gas stations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of of refuelling points and stations for all other fuel types ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of recharging points for electric vehicles and the conditions for their use ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of service areas and rest areas ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Availability of recharging points and stations for electric vehicles ![Status](https://img.shields.io/badge/status-pending-yellow)

**Definition**: dynamic information reflecting the state and status of charging points and stations for electric vehicles.

---
### Availability of refuelling points and stations for alternative fuel types ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location and length of traffic queues ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Price of ad hoc recharging_refuelling ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Traffic speed ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Waiting times at border crossings ![Status](https://img.shields.io/badge/status-pending-yellow)
