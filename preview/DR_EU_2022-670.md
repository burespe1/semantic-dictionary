...
### static and dynamic traffic regulations ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location and identification of traffic signs reflecting traffic regulations and identifying dangers ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### other static and dynamic traffic regulations ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### variable road user charges and available payment methods, including retail channels and fulfilment methods ![Status](https://img.shields.io/badge/status-finalised-blue)
...
### location of compressed natural gas, liquefied natural gas, liquefied petroleum gas stations ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of of refuelling points and stations for all other fuel types ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of recharging points for electric vehicles and the conditions for their use ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of service areas and rest areas ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### road width ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### availability of recharging points and stations for electric vehicles ![Status](https://img.shields.io/badge/status-finalised-blue)

**Definition**: dynamic information reflecting the state and status of charging points and stations for electric vehicles.

---
### availability of refuelling points and stations for alternative fuel types ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location and length of traffic queues ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### price of ad hoc recharging_refuelling ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### traffic speed ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### waiting times at border crossings ![Status](https://img.shields.io/badge/status-finalised-blue)
