...
**Generated on:** 2025-07-11 13:24:32

## Level of Service 1 (data regarded as essential for the basic functioning of multimodal travel information services) – Location search (access nodes)

### geometry_map layout structure of access nodes ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### identified access nodes ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of Service 1 (data regarded as essential for the basic functioning of multimodal travel information services) – Location search (origin_destination)

### addresses (building number, street name, postcode) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### points of interest (related to transport information) to which people may wish to travel ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### topographic places (city, town, village, suburb, administrative unit) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of Service 1 (data regarded as essential for the basic functioning of multimodal travel information services) – Trip plan computation

### accessibility of access nodes, and paths within an interchange (such as existence of lifts, escalators) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### board services (such as toilets) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### connection where interchanges may be made ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### default transfer times at interchanges ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### facilities of access nodes (including platform information, help desk_information points, ticket booths, lifts_stairs, entrances and exit locations) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### hours of operation ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### network topology and routes_lines (topology) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### path shared with pedestrians ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### pedestrian network and accessibility facilities ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### planned interchanges between guaranteed scheduled services ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### road network (including segregated lanes for bus_taxi) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### site assistance) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### timetables ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### transport operators ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of Service 1 (data regarded as essential for the basic functioning of multimodal travel information services) – Trip plans

### operational calendar, mapping day types to calendar dates ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### disruptions, such as network closures and_or diversions, and when possible, the reason ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### for scheduled transport ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### time status information, such as estimated departure and arrival times of services, delays, cancellations, guaranteed connections monitoring ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of service 2 – Auxiliary information

### Fi, capacity and access conditions for bicycles ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### for scheduled transport and transport on demand where relevant ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of service 2 – Availability check and location

### sharing availability and location ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### street) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### where and how to buy tickets for scheduled transport, including retail channels, fulfilment methods, payment methods ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### where and how to pay for parking, including retail channels, fulfilment methods, payment methods ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of service 2 – Information service on parking tariffs

### for transport on demand and personal transport ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### Park & Drive stops ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Park & Ride stops ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### scooter parking zones ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### secure bike parking (such as locked bike garage) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### sharing stations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### street), including accessible parking places for persons with disabilities and persons with reduced mobility ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of service 3 – Detailed common standard and special fare query

### basic booking conditions, such as purchase windows, validity periods, routing restrictions zonal sequence fares, minimum stay ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### basic commercial conditions such as refunding, replacing, exchanging or transferring ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### on products such as parking and travel, minimum stay) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### passenger classes (classes of passenger such as adult, child, senior, student, military_veteran, passenger with disability and passenger with reduced mobility, and qualifying conditions, and classes of travel) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### point pairs including daily and weekly fares_zonal fare prices_flat fare prices) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of service 3 – Information service

### responsive transport services, including retail channels, fulfilment methods, payment methods ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of service 3 – Occupancy information of the vehicle
...
### band by transport mode_combination of transport modes ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### parameters needed to calculate an environmental factor such as greenhouse gas emissions per vehicle type or passenger mile or per distance walked ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### parameters needed to calculate fuel consumption of conventional and alternative fuels ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### side cycling, shared surface, on_off road, scenic route, “walk only”, turn or access restrictions, e.g., against flow of traffic) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### Information on parking tariffs ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of Service 4 – Historic travel and traffic data on delays
...
---
## Level of Service 4 – Observed data on cancellations

### for scheduled transport: cancellations, and when possible the reason, of flights ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### for scheduled transport: cancellations, and when possible the reason, of rail passenger services ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### for scheduled transport: cancellations, and when possible the reason, of regular bus and coach services with a scheduled distance of 250 km or more ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### for scheduled transport: cancellations, and when possible the reason, of sea and inland waterways passenger services ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
## Level of Service 4 – Observed data on delays and passing time
...
---
### for scheduled transport: length of, and when possible the reason for, delays in departure of more than 90 minutes for sea and inland waterways passenger services (in accordance with Article 18 of Regulation (EU) No 1177_2010) ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### for scheduled transport: length of, and when possible the reason for, flight delays at departure of at least 120 minutes, and flight delays at arrival of at least 180 minutes (in accordance with Articles 5 and 6 of Regulation (EC) No 261_2004) ![Status](https://img.shields.io/badge/status-pending-yellow)
