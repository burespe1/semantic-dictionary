...
**Generated on:** 2025-07-28 16:56:04

## Level of Service 1 – Location search (access nodes)

### geometry_map layout structure of access nodes ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_geometry_map-layout--access-nodes.md)
...
---
### identified access nodes ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_identified-access-nodes.md)
...
### addresses (building number, street name, postcode) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_addresses.md)
...
---
### points of interest (related to transport information) to which people may wish to travel ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_points-of--to-travel.md)
...
---
### topographic places (city, town, village, suburb, administrative unit) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_topographic-places.md)
...
### disruptions, such as network closures and_or diversions, and when possible, the reason ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/passing-times--auxiliary-information_disruptions-such--the-reason.md)
...
---
### time status information, such as estimated departure and arrival times of services, delays, cancellations, guaranteed connections monitoring ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/passing-times--auxiliary-information_time-status--connections-monitoring.md)
...
### the minimum dynamic information providing insight into the operational status of access nodes features ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/passing-times--auxiliary-information_operational-status-of-access-nodes.md)
...
### accessibility of access nodes, and paths within an interchange (such as existence of lifts, escalators) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_accessibility-of--an-interchange.md)
...
---
### board services (such as toilets) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_board-services.md)
...
---
### connection where interchanges may be made ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_connection-where--be-made.md)
...
---
### cycle network (cycle tracks, cycle lanes, bus-and-cycle lanes, on-road shared with vehicles, on-path shared with pedestrians) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_cycle-network.md)
...
---
### default transfer times at interchanges ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_default-transfer--at-interchanges.md)
...
---
### facilities of access nodes (including platform information, help desk_information points, ticket booths, lifts_stairs, entrances and exit locations) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_facilities-of-access-nodes.md)
...
---
### hours of operation ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_hours-of-operation.md)
...
---
### network topology and routes_lines (topology) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_network-topology-and-routes_lines.md)
...
---
### pedestrian network and accessibility facilities ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_pedestrian-network--accessibility-facilities.md)
...
---
### planned interchanges between guaranteed scheduled services ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_planned-interchanges--scheduled-services.md)
...
---
### road network (including segregated lanes for bus_taxi) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_road-network.md)
...
---
### timetables ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_timetables.md)
...
---
### transport operators ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_transport-operators.md)
...
### existence of assistance services (such as existence of on-site assistance) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_site-assistance.md)
...
### operational calendar, mapping day types to calendar dates ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plans_operational-calendar--calendar-dates.md)
...
### vehicle facilities, including classes of carriage, on-board Wi-Fi, capacity and access conditions for bicycles ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/auxiliary-information_vehicle-facilities.md)
...
### fare network data (fare zones/stops and fare stages) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/auxiliary-information_fare-network-data.md)
...
---
### standard fare structures (point to point including daily and weekly fares, zonal fares, flat fares) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/auxiliary-information_standard-fare-structures.md)
...
### car parking spaces available (on and off-street) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/availability-check-and-location_dynamic-information--parking-space.md)
...
### where and how to buy tickets for scheduled transport, including retail channels, fulfilment methods, payment methods ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/information-service_where-and-how-buy-tickets.md)
...
---
### where and how to pay for parking, including retail channels, fulfilment methods, payment methods ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/information-service_where-and-how-pay-parking.md)
...
### minimum dynamic information on parking tariffs ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/information-service--parking-tariffs_minimum-dynamic-information.md)
...
### car sharing stations ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_car-sharing-stations.md)
...
### bike-sharing stations ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_bike-sharing-stations.md)
...
---
### location of parking places (on and off-street), including accessible parking places for persons with disabilities and persons with reduced mobility ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_location-of-parking-places.md)
...
---
### park & Drive stops ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_park--drive-stops.md)
...
---
### park & ride stops ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_park--ride-stops.md)
...
---
### scooter parking zones ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_scooter-parking-zones.md)
...
---
### secure bike parking (such as locked bike garage) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/location-search_secure-bike-parking.md)
...
### basic booking conditions, such as purchase windows, validity periods, routing restrictions zonal sequence fares, minimum stay ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/detailed-common--fare-query_basic-booking--minimum-stay.md)
...
---
### basic commercial conditions such as refunding, replacing, exchanging or transferring ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/detailed-common--fare-query_basic-commercial--or-transferring.md)
...
---
### passenger classes (classes of passenger such as adult, child, senior, student, military_veteran, passenger with disability and passenger with reduced mobility, and qualifying conditions, and classes of travel) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/detailed-common--fare-query_passenger-classes.md)
...
### how to book demand-responsive transport services, including retail channels, fulfilment methods, payment methods ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/information-service_how-to-book--transport-services.md)
...
### dynamic information indicating the occupancy of vehicles of scheduled and on-demand mobility services ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/occupancy-information--the-vehicle_dynamic-information.md)
...
### estimated travel times by day type and time-band by transport mode/combination of transport modes ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plan-computation_estimated-travel-times.md)
...
---
### parameters needed to calculate an environmental factor such as greenhouse gas emissions per vehicle type or passenger mile or per distance walked ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plans_parameters-needed--distance-walked.md)
...
---
### parameters needed to calculate fuel consumption of conventional and alternative fuels ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/trip-plans_parameters-needed--alternative-fuels.md)
...
### information on parking tariffs ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/information-on-parking-tariffs.md)
...
### delay ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/historic-travel--on-delays_delay.md)
...
### cancellations, and when possible the reason, of flights ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/observed-data-on-cancellations_cancelations-and-reason-flights.md)
...
---
### cancellations, and when possible the reason, of rail passenger services ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/observed-data-on-cancellations_cancelations-and-reason-rail.md)
...
---
### cancellations, and when possible the reason, of regular bus and coach services with a scheduled distance of 250 km or more ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/observed-data-on-cancellations_cancelations-and-reason-bus.md)
...
---
### cancellations, and when possible the reason, of sea and inland waterways passenger services ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/observed-data-on-cancellations_cancelations-and-reason-waterways.md)
...
---
### length of, and when possible the reason for, delays in departure of more than 90 minutes for sea and inland waterways passenger services (in accordance with Article 18 of Regulation (EU) No 1177_2010) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/observed-data--passing-time_length-and-reason-of-delays-waterways.md)
...
---
### length of, and when possible the reason for, flight delays at departure of at least 120 minutes, and flight delays at arrival of at least 180 minutes (in accordance with Articles 5 and 6 of Regulation (EC) No 261_2004) ![Status](https://img.shields.io/badge/status-under_review-ffc107) [link](../drafts/DR_EU_2024-490/observed-data--passing-time_length-and-reason-of-delays-flight.md)
