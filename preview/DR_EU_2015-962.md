...
### accidents and incidents ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### availability of charging points for electric vehicles ![Status](https://img.shields.io/badge/status-pending-yellow)

**Definition**: dynamic information reflecting the state and status of charging points and stations for electric vehicles.

---
### availability of delivery areas ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### availability of parking places ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### bridge closures ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### cost of parking ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### direction of travel on reversible lanes ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### dynamic speed limits ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### lane closures ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### overtaking bans on heavy goods vehicles ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### poor road conditions ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### road closures ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### roadworks ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### temporary traffic management measures ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### variable road user charges and available payment methods ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### weather conditions affecting road surface and visibility ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### EU Member States ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### location and length of queues ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### speed ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### traffic volume ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### travel times ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### Freight delivery regulations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Identification of tolled roads, applicable fixed road user charges and available payment methods ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of charging points for electric vehicles and the conditions for their use ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of compressed natural gas, liquefied natural gas, liquefied petroleum gas, and hydrogen stations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of delivery areas ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of parking places and service areas ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of public transport stops and interchange points ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Location of tolling stations ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Road classification ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Speed limits ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Traffic circulation plans ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### Traffic signs reflecting traffic regulations and identifying dangers ![Status](https://img.shields.io/badge/status-pending-yellow)
...
### geometry ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### gradients ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### junctions ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### number of lanes ![Status](https://img.shields.io/badge/status-pending-yellow)
...
---
### road width ![Status](https://img.shields.io/badge/status-pending-yellow)
