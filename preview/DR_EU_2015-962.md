...
### accidents and incidents ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### availability of charging points for electric vehicles ![Status](https://img.shields.io/badge/status-accepted-2196f3)

**Definition**: dynamic information reflecting the state and status of charging points and stations for electric vehicles.

---
### availability of delivery areas ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### availability of parking places ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### bridge closures ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### cost of parking ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### direction of travel on reversible lanes ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### dynamic speed limits ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### lane closures ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### overtaking bans on heavy goods vehicles ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### poor road conditions ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### road closures ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### roadworks ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### temporary traffic management measures ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### variable road user charges and available payment methods ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### weather conditions affecting road surface and visibility ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
### location and length of queues ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### speed ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### traffic volume ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### travel times ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### waiting times at border crossings to non-EU Member States ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
### freight delivery regulations ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### identification of tolled roads, applicable fixed road user charges and available payment methods ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### location of charging points for electric vehicles and the conditions for their use ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### location of compressed natural gas, liquefied natural gas, liquefied petroleum gas, and hydrogen stations ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### location of delivery areas ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### location of parking places and service areas ![Status](https://img.shields.io/badge/status-revised-673ab7)
...
---
### location of public transport stops and interchange points ![Status](https://img.shields.io/badge/status-revised-673ab7)
...
---
### location of tolling stations ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### road classification ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### speed limits ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### traffic circulation plans ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### traffic signs reflecting traffic regulations and identifying dangers ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
### geometry ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### gradients ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### junctions ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### number of lanes ![Status](https://img.shields.io/badge/status-accepted-2196f3)
...
---
### road width ![Status](https://img.shields.io/badge/status-revised-673ab7)
