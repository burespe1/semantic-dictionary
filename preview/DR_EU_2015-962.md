...
### accidents and incidents ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### availability of charging points for electric vehicles ![Status](https://img.shields.io/badge/status-finalised-blue)

**Definition**: dynamic information reflecting the state and status of charging points and stations for electric vehicles.

---
### availability of delivery areas ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### availability of parking places ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### bridge closures ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### cost of parking ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### direction of travel on reversible lanes ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### dynamic speed limits ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### lane closures ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### overtaking bans on heavy goods vehicles ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### poor road conditions ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### road closures ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### roadworks ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### temporary traffic management measures ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### variable road user charges and available payment methods ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### weather conditions affecting road surface and visibility ![Status](https://img.shields.io/badge/status-finalised-blue)
...
### location and length of queues ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### speed ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### traffic volume ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### travel times ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### waiting times at border crossings to non-EU Member States ![Status](https://img.shields.io/badge/status-finalised-blue)
...
### freight delivery regulations ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### identification of tolled roads, applicable fixed road user charges and available payment methods ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of charging points for electric vehicles and the conditions for their use ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of compressed natural gas, liquefied natural gas, liquefied petroleum gas, and hydrogen stations ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of delivery areas ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of parking places and service areas ![Status](https://img.shields.io/badge/status-modified-purple)
...
---
### location of public transport stops and interchange points ![Status](https://img.shields.io/badge/status-modified-purple)
...
---
### location of tolling stations ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### road classification ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### speed limits ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### traffic circulation plans ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### traffic signs reflecting traffic regulations and identifying dangers ![Status](https://img.shields.io/badge/status-finalised-blue)
...
### geometry ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### gradients ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### junctions ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### number of lanes ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### road width ![Status](https://img.shields.io/badge/status-modified-purple)
