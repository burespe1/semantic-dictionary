...
### category of the event_condition ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### driving behavior advice (where appropriate) ![Status](https://img.shields.io/badge/status-finalised-blue)
...
---
### location of the event_condition ![Status](https://img.shields.io/badge/status-finalised-blue)
